...
$query2 = 'SELECT * FROM vst_Registro WHERE idCliente='.$busqueda['cliente'].' AND fecha BETWEEN "'.$busqueda['fechaInicio'].'" AND "'.$busqueda['fechaFin'].'";';
