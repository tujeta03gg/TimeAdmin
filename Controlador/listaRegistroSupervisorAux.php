...
$query2 = 'SELECT * FROM vst_Registro WHERE idSupervisor='.$idSupervisor.' AND auxiliar="'.$busqueda['auxiliar'].'" AND fecha BETWEEN "'.$busqueda['fechaInicio'].'" AND "'.$busqueda['fechaFin'].'";';
